...
class TextSummarization(crowdkit.aggregation.base_aggregator.BaseAggregator):
    ...
    **To use this method, you need to install Crowd-Kit with additional dependencies with `pip install crowd-kit[transformers]`**
    ...
    def __init__(
        ...
        permutation_aggregator: typing.Optional[crowdkit.aggregation.base_aggregator.BaseAggregator] = None,
        device: str = 'cpu'
    ) -> None:
    ...
    permutation_aggregator: typing.Optional[crowdkit.aggregation.base_aggregator.BaseAggregator]
    device: str
