...
def test_bradley_terry_equal(
    n_iter: int, tol: float, result_equal: pd.Series, data_equal: pd.DataFrame
) -> None:
...
def test_noisy_bradley_terry(
    n_iter: int, tol: float, data_abc: pd.DataFrame, noisy_bt_result: pd.Series
) -> None:
...
def test_noisy_bradley_terry_equal(
    data_equal: pd.DataFrame, noisy_bt_result_equal: pd.Series
) -> None:
...
def test_zero_iter(
    agg_class: Any, data_equal: pd.DataFrame, result_equal: pd.Series
) -> None:
