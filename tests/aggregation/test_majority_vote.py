...
from .data_gold_mv import multiple_gt_df  # noqa F401
from .data_gold_mv import multiple_gt_gt  # noqa F401
from .data_gold_mv import multiple_gt_aggregated, multiple_gt_skills  # noqa F401
...
def test_majority_vote_with_missing_skills_value(
    ...
    frauded_tasks = simple_answers_df[
        simple_answers_df["worker"] == "0c3eb7d5fcc414db137c4180a654c06e"
    ]["task"]
...
def test_segmentation_majority_vote_with_missing_skills_value(
    ...
    assert_series_equal(
        mv.fit_predict(answers_df, skills=skills), image_with_skills_mv_result
    )
...
def test_segmentation_majority_vote_with_missing_skills_ignore(
    ...
    skills = skills.drop(
        ["e044b0849dfa9ce3dee5debbefb3b5da", "be37db5784b50d08d2702f36317a3074"]
    )
