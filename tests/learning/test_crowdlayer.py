...
def test_crowdlayer_vb(toy_logits: torch.Tensor, toy_workers: torch.Tensor) -> None:
...
def test_crowdlayer_vw(toy_logits: torch.Tensor, toy_workers: torch.Tensor) -> None:
...
def test_crowdlayer_vw_b(toy_logits: torch.Tensor, toy_workers: torch.Tensor) -> None:
...
def test_crowdlayer_mw(toy_logits: torch.Tensor, toy_workers: torch.Tensor) -> None:
